...
## 2026-09-07 (round 61) — `display:table` with no real table-row/table-cell descendant silently dropped its WHOLE box (image and caption both), instead of falling back to block layout — en.wikipedia.org's own gopher-mascot figure vanished entirely (engine#149)
